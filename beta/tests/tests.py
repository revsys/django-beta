...
class BetaModelTests(TestCase):
    def test_simple_creation(self):
        ...
        self.assertTrue(
            BetaSignup.objects.create(email="foo1@bar.com", first_name="Frank")
        )
        self.assertTrue(
            BetaSignup.objects.create(
                email="foo2@bar.com", first_name="Frank", last_name="Wiles"
            )
        )
    ...
    def test_duplicate_creation(self):
        ...
        self.assertRaises(
            IntegrityError, BetaSignup.objects.create, email="foo@bar.com"
        )
